...
Define the Django admin action that merges two or more venues into one survivor, including confirmation, atomic reassignment of locations and dishes, and conflict handling for ratings and saved dishes.
