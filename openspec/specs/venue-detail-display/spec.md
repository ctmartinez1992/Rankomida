...
Define how the public venue detail page presents Venue and VenueLocation data: which fields are visible, how blank values are omitted, when location facts flatten into the hero, and when a Locations segment of compact teasers links through to location detail.
